...
public class ButtonSwitchFragment extends Fragment {
	...
	public void changeFragment(int index) {
		...
		case 2:
			...
			break;
		/*
		 * case 0: fragTrs.replace(R.id.lyt_main_fragment_container, fragLeft);
		 * break; case 1: fragTrs.replace(R.id.lyt_main_fragment_container,
		 * fragCenter); break; case 2:
		 * fragTrs.replace(R.id.lyt_main_fragment_container, fragRight); break;
		 */
		}
		fragTrs.commit();
	}
